...
Markdown es un lenguaje de marcado ligero cuyo objetivo principal es permitir que el texto escrito en formato plano sea fácil de leer y escribir, tanto en su versión original como cuando es convertido a otros formatos. Su sintaxis es simple e intuitiva: usa caracteres comunes del teclado —como asteriscos, almohadillas o guiones— para aplicar formato, crear listas, títulos, enlaces, tablas y más.
Markdown se utiliza ampliamente en proyectos de software debido a su facilidad para documentar, su compatibilidad con repositorios como GitHub y su capacidad de mantener archivos limpios, ordenados y legibles para cualquier persona que participe en el proyecto.
